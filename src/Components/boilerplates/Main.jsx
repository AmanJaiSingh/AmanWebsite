    ...
    <div className="h-screen flex justify-around pb-28 bg-gradient-to-b from-gray-200 to-white-500">
      <div className="flex items-center  pr-20">
        <div className=" pl-">
          ...
          <div>
            <Link to={props.visit}>
              <button className=" duration-500 bg-blue-400 border-blue-400 border-2 text-white text-2xl p-3 hover:text-blue-400 hover:bg-gray-200 hover:border-blue-400  rounded-full">
                {props.btname}
              </button>
            </Link>
          </div>
      ...
      <div className="flex items-center">
        <div className="bounce">
          <img src={web} alt="Img comin soon" />
        </div>
      </div>
    </div>
  );
